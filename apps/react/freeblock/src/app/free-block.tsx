...
const Free = () => {
  ...
  <div className="surface-0 text-center">
      <div className="mb-3 font-bold text-3xl">
          <span className="text-gray-900">One Product, </span>
          <span className="text-blue-600">Many Solutions</span>
      </div>
      <div className="text-gray-700 mb-6">Ac turpis egestas maecenas pharetra convallis posuere morbi leo urna.</div>
      <div className="grid">
          <div className="grid-cols-12 md:grid-cols-4 mb-4 px-5">
              <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
                  <i className="pi pi-desktop text-4xl text-blue-500"></i>
              </span>
              <div className="text-gray-900 text-xl mb-3 font-medium">Built for Developers</div>
              <span className="text-gray-700 line-height-3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</span>
          </div>
          <div className="grid-cols-12 md:grid-cols-4 mb-4 px-5">
              <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
                  <i className="pi pi-lock text-4xl text-blue-500"></i>
              </span>
              <div className="text-gray-900 text-xl mb-3 font-medium">End-to-End Encryption</div>
              <span className="text-gray-700 line-height-3">Risus nec feugiat in fermentum posuere urna nec. Posuere sollicitudin aliquam ultrices sagittis.</span>
          </div>
          <div className="grid-cols-12 md:grid-cols-4 mb-4 px-5">
              <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
                  <i className="pi pi-check-circle text-4xl text-blue-500"></i>
              </span>
              <div className="text-gray-900 text-xl mb-3 font-medium">Easy to Use</div>
              <span className="text-gray-700 line-height-3">Ornare suspendisse sed nisi lacus sed viverra tellus. Neque volutpat ac tincidunt vitae semper.</span>
          </div>
          <div className="grid-cols-12 md:grid-cols-4 mb-4 px-5">
              <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
                  <i className="pi pi-globe text-4xl text-blue-500"></i>
              </span>
              <div className="text-gray-900 text-xl mb-3 font-medium">Fast & Global Support</div>
              <span className="text-gray-700 line-height-3">Fermentum et sollicitudin ac orci phasellus egestas tellus rutrum tellus.</span>
          </div>
          <div className="grid-cols-12 md:grid-cols-4 mb-4 px-5">
              <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
                  <i className="pi pi-github text-4xl text-blue-500"></i>
              </span>
              <div className="text-gray-900 text-xl mb-3 font-medium">Open Source</div>
              <span className="text-gray-700 line-height-3">Nec tincidunt praesent semper feugiat. Sed adipiscing diam donec adipiscing tristique risus nec feugiat. </span>
          </div>
          <div className="grid-cols-12 md:grid-cols-4 md:mb-4 mb-0 px-3">
              <span className="p-3 shadow-2 mb-3 inline-block" style={{ borderRadius: '10px' }}>
                  <i className="pi pi-shield text-4xl text-blue-500"></i>
              </span>
              <div className="text-gray-900 text-xl mb-3 font-medium">Trusted Security</div>
              <span className="text-gray-700 line-height-3">Mattis rhoncus urna neque viverra justo nec ultrices. Id cursus metus aliquam eleifend.</span>
          </div>
      </div>
  </div>
      `;
  ...
  return (
    <>
      {/* <BlockViewer header="Hero" code={block1} free>
        <div className="grid mx-0 mt-0 surface-0 text-black">
          <div className="grid-cols-12 md:grid-cols-6 p-6 text-center md:text-left flex items-center ">
            <section>
              ...
              <p className="mt-0 mb-4 text-gray-700 leading-3">
      ...
      <BlockViewer
        header="Feature"
        code={block2}
        containerClassName="bg-white px-4 py-8 md:px-6 lg:px-8"
        free
      >
        <div className="bg-white text-center">
          <div className="mb-3 font-bold text-3xl">
            <span className="text-gray-900">One Product, </span>
            <span className="text-blue-500">Many Solutions</span>
          </div>
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 lg:col-span-4 h-fit">
              <span
                className="p-3 !shadow-lg mb-3 inline-block"
              ...
              <div className="text-gray-900 text-xl font-medium">
                ...
                <span className="text-gray-700 text-base font-normal line-height-1 w-full">
            ...
            <div className="col-span-12 lg:col-span-4">
              ...
              <div className="text-gray-900 text-xl font-medium">
                <span className="block">Fast & Global Support</span>
                <span className="text-gray-700 text-base font-normal line-height-1 w-full">
